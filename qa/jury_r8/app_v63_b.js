...
const $main = document.getElementById('main');
    ...
    function renderPlayerTypeahead(input) {
      ...
      if (local.length) {
        ...
        box.innerHTML = '<div class="typeahead-item muted">Index cold \u2014 first search takes 10\u201325s, then it\u2019s instant\u2026</div>';
      } else {
    ...
    function todayPageHtml(data) {
      ...
      html += '<a class="sponsor-strip" href="https://uprightcreativeco.com" target="_blank" rel="noopener" aria-label="Sponsored by Upright Creative">'
        + '<img src="/static/img/upright-crown.png" alt="" aria-hidden="true" />'
    ...
    function armSkeletonWatchdog($el, label, retryExpr) {
      if (!$el) return () => {};
      // R7-4: hard-error deadline (25s) must exceed api()'s 30s ceiling + retry,
